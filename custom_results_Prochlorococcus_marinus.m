...
%   plot(tV_LowP1(:,1), tV_LowP1(:,2),tV_LowP1(:,1), tV_LowP2,tV_LowP1(:,1), tV_LowP3, '.r', 'markersize', 4)
  ...
  subplot(2,3,5)
  plot(t, (par.n_NV + StVar_pro99(:,5))./(1 + StVar_pro99(:,4)) *106/16, 'g', t, (par.n_NV + StVar_LowN(:,5))./(1 + StVar_LowN(:,4)) *106/16, 'b', t, (par.n_NV + StVar_LowP(:,5))./(1 + StVar_LowP(:,4)) *106/16, 'k', 'linewidth', 2)
  xlabel('time, days')
  ylabel('Nitrogen Redfield ratio proportion, -')
  
  subplot(2,3,6)
  plot(t, (par.n_PV + StVar_pro99(:,6))./(1 + StVar_pro99(:,4)) *106, 'g', t, (par.n_PV + StVar_LowN(:,6))./(1 + StVar_LowN(:,4)) *106, 'b', t, (par.n_PV + StVar_LowP(:,6))./(1 + StVar_LowP(:,4)) *106, 'k', 'linewidth', 2)
  xlabel('time, days')

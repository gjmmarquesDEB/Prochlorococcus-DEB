...
%   Preserve = prdData.reserve;
  ...
  plot(t, EXC_pro99, 'g')
  hold on
  errorbar(tXC_pro99(:,1), tXC_pro99(:,2), auxData.SD.tXC_pro99, '.r', 'markersize', 20, 'linewidth', 4)
  ...
  plot(t, EXN_pro99, 'g')
  hold on
  errorbar(tXN_pro99(:,1), tXN_pro99(:,2), auxData.SD.tXN_pro99, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ...
  plot(t, EXP_pro99, 'g')
  hold on
  errorbar(tXP_pro99(:,1), tXP_pro99(:,2), auxData.SD.tXP_pro99, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ...
  plot(t, V_pro99, 'g')
  hold on
  errorbar(tV_pro99(:,1), tV_pro99(:,2), auxData.SD.tV_pro99, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ...
  plot(t, EXC_LowN, 'g')
  hold on
  errorbar(tXC_LowN(:,1), tXC_LowN(:,2), auxData.SD.tXC_LowN, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ylabel('Carbon concentration, \mumol L^{-1}')
  ...
  plot(t, EXN_LowN, 'g')
  hold on
  errorbar(tXN_LowN(:,1), tXN_LowN(:,2), auxData.SD.tXN_LowN, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ylabel('Nitrogen concentration, \mumol L^{-1}')
  ...
  plot(t, EXP_LowN, 'g')
  hold on
  errorbar(tXP_LowN(:,1), tXP_LowN(:,2), auxData.SD.tXP_LowN, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ylabel('Phosphorous concentration, \mumol L^{-1}')
  ...
  plot(t, V_LowN, 'g')
  hold on
  errorbar(tV_LowN(:,1), tV_LowN(:,2), auxData.SD.tV_LowN, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ylabel('Biomass, mol L^{-1}')  
  ...
  plot(t, EXC_LowP, 'g')
  hold on
  errorba(tXC_LowP(:,1), tXC_LowP(:,2), auxData.SD.tXC_LowP, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ylabel('Carbon concentration, \mumol L^{-1}')
  ...
  plot(t, EXN_LowP, 'g')
  hold on
  errorbar(tXN_LowP(:,1), tXN_LowP(:,2), auxData.SD.tXN_LowP, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ylabel('Nitrogen concentration, \mumol L^{-1}')
...
%print -dpng results_Prochlorococcus_marinus_01.png
  ...
  plot(t, EXP_LowP, 'g')
  hold on
  errorbar(tXP_LowP(:,1), tXP_LowP(:,2), auxData.SD.tXP_LowP, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ylabel('Phosphorous concentration, \mumol L^{-1}')
  ...
  plot(t, V_LowP, 'g')
  hold on
  errorbar(tV_LowP(:,1), tV_LowP(:,2), auxData.SD.tV_LowP, '.r', 'markersize', 20, 'linewidth', 4)
  set(gca, 'Fontsize', 15, 'Box', 'on')
  xlabel('time, days')
  ylabel('Biomass, mol L^{-1}')  

...
par.K_P = .0000021;                                         free.K_P = 1;       units.K_P='M';                                        label.K_P='K_P';             % Mikhaelis-Menten const. Krumhardt
...
par.j_EP_Am = .772*.0005*1e-15*24/2.6095e-15*1e-3;          free.j_EP_Am = 1;   units.j_EP_Am='mol d^{-1}/molM_V';                    label.j_EP_Am='j_E_PAm';    % P assimilation rates, Krumhardt
...
par.y_EP_V = 106;                                           free.y_EP_V = 1;    units.y_EP_V='molE_P molM_V^{-1}';                    label.y_EP_V='y_E_PV';      % yield factor of P-reserve to structure
...
par.n_HV = 263/106; free.n_HV = 0;  units.n_HV = '-'; label.n_HV = 'chem. index of hydrogen in structure';
par.n_OV = 10/106;  free.n_OV = 0;  units.n_OV = '-'; label.n_OV = 'chem. index of oxygen in structure';
par.n_NV = 16/106;  free.n_NV = 0;  units.n_NV = '-'; label.n_NV = 'chem. index of nitrogen in structure';
par.n_PV = 1/106;   free.n_PV = 0;  units.n_PV = '-'; label.n_PV = 'chem. index of phosphorous in structure';
%

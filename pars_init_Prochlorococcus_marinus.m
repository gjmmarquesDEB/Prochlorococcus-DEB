...
par.j_EN_M = .010;                                             free.j_EN_M = 1;    units.j_EN_M='molE_N molM_V^{-1} d^{-1}';             label.j_EN_M='j_E_NM';      % N reserve maintenance rates, from Lorena 
par.j_EP_M = .010/16;                                         free.j_EP_M = 1;    units.j_EP_M='molE_P molM_V^{-1} d^{-1}';             label.j_EP_M='j_E_PM';      % P reserve maintenance rates, from Lorena 
...
par.kappaXC = 0.9;                                             free.kappaXC = 0;   units.kappaXC='-';                                    label.kappaXC='kappa_X_C'; % kappas - fraction of excreted flux added to the assimilable C source
par.kappaXN = 0.9;                                             free.kappaXN = 0;   units.kappaXN='-';                                    label.kappaXN='kappa_X_N'; % kappas - fraction of excreted flux added to the assimilable N source
par.kappaXP = 0.9;                                             free.kappaXP = 0;   units.kappaXP='-';                                    label.kappaXP='kappa_X_P'; % kappas - fraction of excreted flux added to the assimilable P source
